...
namespace PruebasSwitch
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            if (cuenta > 50)
            {
                cuenta = (int)(cuenta * 0.9); // Aplica un descuento del 10%
                Console.WriteLine("Se aplicó un descuento del 10% por superar los $50.");
            }

            if (cuenta > 200)
            {
                cuenta = (int)(cuenta * 0.75);//Aplica descuento adicional del 25%
                Console.WriteLine("Se aplico un descuento adicional del 25% por superar los $200.");
            }
